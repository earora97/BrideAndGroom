...
import com.example.srinivas.brideandgroom.Cheeses;
...
public class ProfileActivity extends AppCompatActivity {
       ...
       // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        mMywed_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ProfileActivity.this, MyWedding.class));
            }
        });
    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new CheeseListFragment(), "Past");
        adapter.addFragment(new CheeseListFragment(), "Present");
        adapter.addFragment(new CheeseListFragment(), "History");
